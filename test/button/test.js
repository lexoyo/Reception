...
if(typeof reception=='undefined') reception = {}
if(!reception.button) reception.button = {}
if(!reception.button["abstract"]) reception.button["abstract"] = {}
reception.button.abstract.ButtonDOMElement = function(nativeElement) {
	if( nativeElement === $_ ) return;
	cocktailCore.domElement.js.EmbeddedDOMElement.call(this,nativeElement);
	this._enabled = true;
	this._text = "Button";
}
reception.button.abstract.ButtonDOMElement.__name__ = ["reception","button","abstract","ButtonDOMElement"];
reception.button.abstract.ButtonDOMElement.__super__ = cocktailCore.domElement.js.EmbeddedDOMElement;
for(var k in cocktailCore.domElement.js.EmbeddedDOMElement.prototype ) reception.button.abstract.ButtonDOMElement.prototype[k] = cocktailCore.domElement.js.EmbeddedDOMElement.prototype[k];
reception.button.abstract.ButtonDOMElement.prototype._enabled = null;
reception.button.abstract.ButtonDOMElement.prototype.enabled = null;
reception.button.abstract.ButtonDOMElement.prototype._text = null;
reception.button.abstract.ButtonDOMElement.prototype.text = null;
reception.button.abstract.ButtonDOMElement.prototype.getEnabled = function() {
	return this._enabled;
}
reception.button.abstract.ButtonDOMElement.prototype.setEnabled = function(value) {
	this._enabled = value;
	return value;
}
reception.button.abstract.ButtonDOMElement.prototype.getText = function() {
	return this._text;
}
reception.button.abstract.ButtonDOMElement.prototype.setText = function(value) {
	this._text = value;
	return this._text;
}
reception.button.abstract.ButtonDOMElement.prototype.__class__ = reception.button.abstract.ButtonDOMElement;
...
if(!reception.button.js) reception.button.js = {}
reception.button.js.ButtonDOMElement = function(nativeElement) {
	if( nativeElement === $_ ) return;
	if(nativeElement == null) {
		nativeElement = js.Lib.document.createElement("input");
		nativeElement.type = "button";
	}
	reception.button.abstract.ButtonDOMElement.call(this,nativeElement);
}
reception.button.js.ButtonDOMElement.__name__ = ["reception","button","js","ButtonDOMElement"];
reception.button.js.ButtonDOMElement.__super__ = reception.button.abstract.ButtonDOMElement;
for(var k in reception.button.abstract.ButtonDOMElement.prototype ) reception.button.js.ButtonDOMElement.prototype[k] = reception.button.abstract.ButtonDOMElement.prototype[k];
reception.button.js.ButtonDOMElement.prototype.setEnabled = function(value) {
	value = reception.button.abstract.ButtonDOMElement.prototype.setEnabled.call(this,value);
	if(value == false) this.getNativeElement().disabled = "disabled"; else this.getNativeElement().disabled = null;
	return value;
}
reception.button.js.ButtonDOMElement.prototype.setText = function(value) {
	value = reception.button.abstract.ButtonDOMElement.prototype.setText.call(this,value);
	this.getNativeElement().value = value;
	return value;
}
reception.button.js.ButtonDOMElement.prototype.__class__ = reception.button.js.ButtonDOMElement;
...
Main.__name__ = ["Main"];
Main.main = function() {
	haxe.Log.trace("start",{ fileName : "Main.hx", lineNumber : 28, className : "Main", methodName : "main"});
	var rootDOMElement = new cocktailCore.domElement.js.ContainerDOMElement(cocktail.nativeElement.NativeElementManager.getRoot());
	var button = new reception.button.js.ButtonDOMElement();
	button.setText("Cocktail Button");
	button.setWidth(150);
	button.setHeight(50);
	button.setX(button.setY(100));
	button.getStyle().setPosition(cocktail.style.PositionStyleValue.absolute);
	rootDOMElement.addChild(button);
	var button2 = new reception.button.js.ButtonDOMElement();
	button2.setText("Click me...");
	button2.setWidth(100);
	button2.setHeight(20);
	button2.setX(button2.setY(0));
	button2.getStyle().setPosition(cocktail.style.PositionStyleValue.absolute);
	button2.setOnMouseUp(function(m) {
		button.setEnabled(!button.getEnabled());
	});
	button2.setOnMouseDown(function(m) {
		var _g = button;
		_g.setX(_g.getX() + 20);
	});
	button2.setOnMouseOver(function(m) {
		var _g = button;
		_g.setY(_g.getY() + 20);
	});
	button2.setOnMouseOut(function(m) {
		var _g = button;
		_g.setY(_g.getY() - 20);
	});
